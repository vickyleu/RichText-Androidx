...
public class RichText implements ImageGetterWrapper, ImageLoadNotify {
    ...
    public Drawable getDrawable(String source) {
        ...
        holder.imageState = ImageHolder.ImageState.INIT;
