...
public class FreeType {
	...
	/*
	 ...
	 imac-3:mathdisplaylib greg$ javah -v -cp build/intermediates/classes/debug -d src/main/cpp/ com.zzhoujay.richtext.mathdisplay.freetype.FreeType
...
//	public static native boolean FT_Set_Transform            (long face, FT_Matrix* matrix, FT_Vector* delta);
    ...
    public static native GlyphSlot.Advance FT_GlyphSlot_Get_advance(long glyphSlot);
...
//	public static native SubGlyph FT_Get_SubGlyph_Info				(long glyphSlot, int subIndex);
    ...
    static { // Load library
        try {
            System.loadLibrary("FreetypeRichText");
					/*
